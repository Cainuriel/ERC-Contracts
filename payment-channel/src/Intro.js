      ...
      async function init() {  
        ...
        if (typeof window.ethereum !== 'undefined') {
          ...
          Swal.fire({
            ...
            text: "Cambie de navegador o puede instalárselo apretando el botón",
          ...
          <div className="bg-dark container col-xl-10 col-xxl-8 px-4 py-5">
            <div className="row align-items-center g-lg-5 py-5">
              <div className="col-lg-7 text-center text-lg-start">
                ...
                <p  className="col-lg-10 fs-4 text-white"> Si usted no dispone de la red de pruebas de ésta blockchain, ella se instalará apretando al botón naranja. Si ya la dispone, cambiará a esa red automáticamente.</p>
              ...
              <div className="col-md-10 mx-auto col-lg-5">
                    ...
                    <button id="btn-firma"  onClick={() => addNetwork()} className="w-100 btn btn-lg btn-warning my-4" type="button">Añadir Red Binance Smart Chain de pruebas</button>

                    <button id="btn-firma"  onClick={() => faucet()} className="w-100 btn btn-lg btn-primary" type="button">Faucet de Binance</button>
                    <hr className="my-4"/>
                    <small id="intro" className="text-muted">...</small>
              <div>
            </div>
          </div>
        </div>
